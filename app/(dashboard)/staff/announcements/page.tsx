...
import { Megaphone, BookOpen, Bell, Loader2 } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <Card className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white border-0 overflow-hidden relative">
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <p className="text-white/70 text-sm">Messages from school administration</p>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-gray-400">No announcements for staff at this time.</p>
          </CardContent>
        </Card>
      ) : (
