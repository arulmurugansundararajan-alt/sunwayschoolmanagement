        ...
        {["all", ...EVENT_TYPES].map((t) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
              filterType === t ? "bg-emerald-600 text-white shadow" : "text-gray-500 hover:bg-gray-100"
            }`}
          >
            {t === "all" ? "All" : t}
          </button>
          ...
          <Card>
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                ...
                <button onClick={goToday} className="text-xs font-semibold text-emerald-600 hover:text-emerald-700 px-2 py-1 rounded hover:bg-emerald-50">
                  Today
                </button>
              </div>
            </CardHeader>
                  ...
                  return (
                    <div
                      ...
                      className={`min-h-[70px] rounded-lg border p-1 text-xs ${
                        isToday ? "border-emerald-400 bg-emerald-50/50 ring-1 ring-emerald-200" :
                        isWeekend ? "bg-gray-50/50 border-gray-100" :
                        "border-gray-100"
                      }`}
                    >
                      <span className={`font-bold ${isToday ? "text-emerald-700" : isWeekend ? "text-gray-400" : "text-gray-700"}`}>
                        {d}
                      </span>
